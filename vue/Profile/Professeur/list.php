...
<main class="col-md-9 col-lg-10 px-md-4">
    ...
    <body>
        ...
        if ($role == "professeur") {
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mt-5 mb-3 d-flex justify-content-between">
                                <h2 class="pull-left">Liste de vos matieres</h2>
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr>";
                                echo "<th>#</th>";
                                echo "<th>Titre de la matiere</th>";
                                echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    //echo "<td>";
                                   // echo '<a href="' . ROOTPAGE . 'professeur/edit/' . $row['mat_id'] . '" class="me-3" ><span class="bi bi-pencil"></span></a>';
                                    //echo '<a href="' . ROOTPAGE . 'professeur/delete/' . $row['mat_id'] . '" ><span class="bi bi-trash"></span></a>';
                                    //echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
            ...
            ?>
            <h2 style="color: red;" class="pull-left">Seul les professeurs peuvent consulter leurs matieres !</h2>
