...
$anneeScolaire = isset($_SESSION['anneeScolaire']) ? unserialize($_SESSION['anneeScolaire']) : new anneeScolaire();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="page-header">
                                <h2>Inserer une annee scolaire</h2>
                            </div>
                            <form action="create" method="post">

                                <div class="form-group">
                                    <label>Annee scolaire :</label>
                                    <input type="text" name="ann_annee" class="form-control" required="required" pattern="[a-zA-Z0-9\s-]+" value="<?php echo $anneeScolaire->ann_annee; ?>">
                                </div>
