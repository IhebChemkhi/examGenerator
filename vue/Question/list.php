                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mt-5 mb-3 d-flex justify-content-between">
                                <h2 class="pull-left">Liste de vos questions</h2>
                                <a href="<?php echo ROOTPAGE . "question/insert"; ?>" class="btn btn-success"><i
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "<tr>";
                                echo "<th>#</th>";
                                echo "<th>La question</th>";
                                echo "<th>La response</th>";
                                echo "<th>Points</th>";
                                echo "</tr>";
                                echo "</thead>";
                                echo "<tbody>";
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>" . "*defini lors de l'ajout de l'examen*" . "</td>";
                                    echo "<td>";
                                    echo '<a href="' . ROOTPAGE . 'question/read/' . $row['ques_id'] . '" class="me-3" ><span class="bi bi-eye"></span></a>';
                                    echo '<a href="' . ROOTPAGE . 'question/edit/' . $row['ques_id'] . '" class="me-3" ><span class="bi bi-pencil"></span></a>';
                                    echo '<a href="' . ROOTPAGE . 'question/delete/' . $row['ques_id'] . '" ><span class="bi bi-trash"></span></a>';
                                    echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
