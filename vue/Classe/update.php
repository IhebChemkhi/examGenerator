                        ...
                        <div class="col-md-12">
                            ...
                            <form action="../update" method="POST">
                                ...
                                <div class="form-group">
                                    <label>Classe :</label>
                                    <input type="text" name="cla_nom" class="form-control" required="required" pattern="[a-zA-Z0-9\s]+" value="<?php echo $classeDb->cla_nom; ?>">
                                </div>

                                <input type="hidden" name="cla_id" value="<?php echo $classeDb->cla_id; ?>" />
