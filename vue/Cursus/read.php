...
if ($role == "administrateur" || $role == "professeur") {
    ?>
            ...
            <div class="wrapper">
                <a href="<?php echo ROOTPAGE . "cursus"; ?>" class="btn btn-success"><i class="bi bi-arrow-left"></i>
                    Retour</a>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            echo '<a href="' . ROOTPAGE . 'cursus/delete/' . $cursusDb->cur_id . '" ><span class="bi bi-trash"></span></a>';
                            echo "</td>";
                            echo "</tr>";
                            echo "</tbody>";
                            echo "</table>";
